  ...
  return (
    <>
      ...
      <section id='main'>
        ...
        {/* Highlight Section */}
        <div className="px-5 md:px-20 lg:px-32 mt-25 space-y-5 fade-in fade-in-left">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-around items-center py-5 text-white mt-10 gap-3 md:gap-0 fade-in fade-in-up">
      ...
      <section id="services" className="py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-10 text-blue-900 fade-in fade-in-right">Dịch Vụ Chuyên Sâu UniProof</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
            {services.map((service, index) => (
              <div key={index} className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition duration-300 fade-in fade-in-up">
      ...
      <section id="testimonials" className="py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-10 text-blue-900 fade-in fade-in-left">Khách Hàng Nói Gì Về Chúng Tôi?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
            {testimonials.map((testi, index) => (
              <div key={index} className="p-8 bg-blue-50 rounded-lg shadow-md border-t-4 border-blue-600 fade-in fade-in-up">
